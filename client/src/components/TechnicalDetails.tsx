  ...
  return (
    <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
      ...
      <div className="space-y-4 text-sm text-gray-500">
        ...
        <p><strong className="text-gray-700">How it works:</strong> HEICFlip uses advanced browser technologies to convert HEIC files to JPG format locally.</p>
        <p><strong className="text-gray-700">Supported Formats:</strong> Currently, we support HEIC, JPG, JPEG, and PNG files. More formats will be added soon.</p>

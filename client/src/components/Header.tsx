...
const Header = () => {
  return (
    <nav className="bg-white shadow-amber-lg border-b border-amber-100">
      <div 
        className="bg-gradient-to-r from-white to-amber-50"
        style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex-shrink-0 flex items-center">
              <div className="h-10 w-10 p-1.5 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 shadow-amber flex items-center justify-center">
                <svg 
                  className="h-7 w-7" 
            ...
            <div className="flex items-center">
              <a 
                href="https://github.com/brookcs3/heicflip" 
